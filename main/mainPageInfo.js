...
function displayWeather(data) {
    ...
    for (let i = 0; i < data.list.length; i += 8) {
        ...
        const sunriseTime = new Date(dayData.sys.sunrise * 1000).toLocaleTimeString();
        const sunsetTime = new Date(dayData.sys.sunset * 1000).toLocaleTimeString();
        ...
        weatherCard.innerHTML = `
            ...
            <p>Max Temperature: ${formatTemperature(dayData.main.temp_max)}°C</p>
            <p>Min Temperature: ${formatTemperature(dayData.main.temp_min)}°C</p>
